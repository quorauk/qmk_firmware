...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______,                   KC_PIPE,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_QUOT, \
      KC_CAPS, KC_NUBS, _______, _______, _______, _______, KC_LPRN, KC_RPRN, _______,  _______, _______, KC_HOME, KC_END,  _______, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      KC_CAPS, LSFT(KC_NUBS), _______,   _______,   _______,  _______, _______, _______, _______,  _______, _______, KC_PGDN, KC_PGUP, _______, \
      _______, _______,       _______,   _______,   _______,  _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, _______, _______, KC_WH_U, KC_WH_D,  AG_NORM,                  KC_MS_L, KC_MS_D,   KC_MS_U, KC_MS_R, _______, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, KC_BTN1, KC_BTN2, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
